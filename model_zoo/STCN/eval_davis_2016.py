...
parser.add_argument('--model', default='model_zoo/STCN/saves/stcn.pth')
parser.add_argument('--davis_path', default='/mnt/ssd/allusers/kai422/data/DAVIS')
parser.add_argument('--output',  default='resuls')
