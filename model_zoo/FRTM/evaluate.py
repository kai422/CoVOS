...
if __name__ == '__main__':
    ...
    paths = dict(
        ...
        davis="/mnt/ssd/allusers/kai422/data/DAVIS",  # DAVIS dataset root
        yt2018="/path/to/ytvos2018",  # YouTubeVOS 2018 root
        output="/home/kai422/workspace/Segmentation/May_VOS/CVOS/CoVOS/frtm/results",  # Output path
    )
    # paths = dict(
    #     models=Path(__file__).parent / "weights",  # The .pth files should be here
    ...
    p = Parameters(weights, args.fast)
    tracker = p.get_model()
