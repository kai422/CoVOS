...
parser.add_argument('--model', default='model_zoo/MiVOS/saves/topk_stm.pth')
parser.add_argument('--davis', default='/mnt/ssd/allusers/kai422/data/DAVIS')
parser.add_argument('--output', default='result/dv2016')
