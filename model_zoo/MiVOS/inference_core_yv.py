...
class InferenceCore:
    ...
    def do_pass(self, key_k, key_v, idx, end_idx):
        ...
        for ti in this_range:
            ...
            self.low_feat[ti] = f4
            out_mask = torch.cat([
                self.prop_net.segment_with_query(
                    this_k[oi], this_v[oi], f16, f8, f4, k16, v16)
    ...
    def interact(self, mask, frame_idx, end_idx, obj_idx):
        ...
        key_k, key_v = self.prop_net.memorize(label_img, self.prob[self.enabled_obj,frame_idx].cuda())
