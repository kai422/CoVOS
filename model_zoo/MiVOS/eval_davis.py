...
parser.add_argument('--model', default='topk_stm/saves/propagation_model.pth')
parser.add_argument('--davis', default='/mnt/ssd/allusers/kai422/dataset_VOS/DAVIS/2017')
parser.add_argument('--output', default = 'result/dv2017')
...
for data in progressbar(test_loader, max_value=len(test_loader), redirect_stdout=True):
    ...
    processor = InferenceCore(prop_model, rgb, k, mem_freq=1)
