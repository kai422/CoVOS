...
def evaluate_sequence(segmentations, annotations, object_info, keyframes, measure='J'):
    """
    ...
    _measures = {'J': davis_jaccard_measure, 'F': davis_f_measure, 'Size': mask_total_pixels}
...
def mask_total_pixels(fg_mask, gt_mask):
